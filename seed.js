...
async function main() {
    ...
    // Add tools with lat and lng included
    let pie = await tools.addTool("Pie", "very delicious pie", "Some Damage", adib._id.toString(), {start: new Date('2025-08-01'), end: new Date('2025-08-07')}, "Hoboken, NJ, USA", "1724515479000.jpeg", 40.743, -74.032);
    pie = pie.insertedId.toString();
    
    let teddy = await tools.addTool("Teddy", "very fluffy teddy bear", "Ok", neel._id.toString(), {start: new Date('2025-08-01'), end: new Date('2025-08-07')}, "Hoboken, NJ, USA", "1724515479001.png", 40.743, -74.032);
    teddy = teddy.insertedId.toString();
    
    let firetruck = await tools.addTool("Firetruck", "big red firetruck", "Like New", tara._id.toString(), {start: new Date('2025-08-01'), end: new Date('2025-08-07')}, "Hoboken, NJ, USA", "1724515479002.jpeg", 40.743, -74.032);
    firetruck = firetruck.insertedId.toString();
    
    let ambulance = await tools.addTool("Ambulance", "super safe ambulance", "Very Damaged", kashish._id.toString(), {start: new Date('2025-08-01'), end: new Date('2025-08-07')}, "Hoboken, NJ, USA", "1724515479003.jpeg", 40.743, -74.032);
    ambulance = ambulance.insertedId.toString();
    
    let policeCar = await tools.addTool("Police car", "fast and furious ride", "Good", patrick._id.toString(), {start: new Date('2025-08-01'), end: new Date('2025-08-07')}, "Hoboken, NJ, USA", "1724515479004.jpeg", 40.743, -74.032);
    policeCar = policeCar.insertedId.toString();
    
    let paintBrushes = await tools.addTool("Paint brushes", "long paint brushes (paint not included)", "Very Good", jey._id.toString(), {start: new Date('2025-08-01'), end: new Date('2025-08-07')}, "Hoboken, NJ, USA", "1724515479005.jpeg", 40.743, -74.032);
    paintBrushes = paintBrushes.insertedId.toString();
    
    let computer = await tools.addTool("Computer", "Fell HumanWare Computer (might contain virus)", "Very Damaged", adib._id.toString(), {start: new Date('2025-08-01'), end: new Date('2025-08-07')}, "Hoboken, NJ, USA", "1724515479006.jpeg", 40.743, -74.032);
    computer = computer.insertedId.toString();
    
    let pc = await tools.addTool("Pc", "ESUS MenBook (antivirus firewall included)", "Like New", neel._id.toString(), {start: new Date('2025-08-01'), end: new Date('2025-08-07')}, "Hoboken, NJ, USA", "1724515479007.jpeg", 40.743, -74.032);
    pc = pc.insertedId.toString();
    
    let missiles = await tools.addTool("Missiles", "fast and explosive", "Minor Damage", tara._id.toString(), {start: new Date('2025-08-01'), end: new Date('2025-08-07')}, "Hoboken, NJ, USA", "1724515479008.jpeg", 40.743, -74.032);
    missiles = missiles.insertedId.toString();
    
    let calculator = await tools.addTool("Calculator", "BI-NoSpire calculator", "Ok", kashish._id.toString(), {start: new Date('2025-08-01'), end: new Date('2025-08-07')}, "Hoboken, NJ, USA", "1724515479009.jpeg", 40.743, -74.032);
    calculator = calculator.insertedId.toString();
    
    // Add ratings to tools
    await ratings.addRating(adib._id.toString(), calculator, "1", "Man this did not work at all!!!!");
